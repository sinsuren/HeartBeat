...
import static protocols.server.heartbeat.NetworkUtils.receiveData;

public class HeartbeatProtocol implements Runnable, Observable<HeartbeatState, HeartbeatEvent> {
